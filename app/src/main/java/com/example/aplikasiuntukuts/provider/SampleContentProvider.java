...
public class SampleContentProvider extends ContentProvider {
    ...
    public String getType(@NonNull Uri uri) {
        String argument = "Unknown URI";
        if(MATCHER.match(uri) == CODE_CHEESE_DIR){
            argument = "vnd.android.cursor.dir/" + AUTHORITY + "." + Cheese.TABLE_NAME;
        }else if(MATCHER.match(uri) == CODE_CHEESE_ITEM){
            argument = "vnd.android.cursor.item/" + AUTHORITY + "." + Cheese.TABLE_NAME;
        }
        return argument;
    }
